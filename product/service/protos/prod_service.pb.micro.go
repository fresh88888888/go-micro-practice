...
type ProdService interface {
	GetProdsList(ctx context.Context, in *ProdRequest, opts ...client.CallOption) (*ProdListResponse, error)
...
func (c *prodService) GetProdsList(ctx context.Context, in *ProdRequest, opts ...client.CallOption) (*ProdListResponse, error) {
...
type ProdServiceHandler interface {
	GetProdsList(context.Context, *ProdRequest, *ProdListResponse) error
...
func RegisterProdServiceHandler(s server.Server, hdlr ProdServiceHandler, opts ...server.HandlerOption) error {
	type prodService interface {
		GetProdsList(ctx context.Context, in *ProdRequest, out *ProdListResponse) error
...
func (h *prodServiceHandler) GetProdsList(ctx context.Context, in *ProdRequest, out *ProdListResponse) error {
